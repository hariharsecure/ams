...
SCHEMA_VERSION = "ams.ams_codex.semantic_oracle_review.v0"
...
def _hook_shim_contract(rule_results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "preflight_commands": [
            "python3 -m ams_codex.cli work-mode-decision --changed-path ams_codex/session_registry.py",
            "python3 -m ams_codex.cli semantic-oracle-review --simulation-sweep-id <sweep-id>",
        ],
