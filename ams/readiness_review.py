...
SCHEMA_VERSION = "ams.ams.readiness_review.v0"
...
def build_readiness_review(
    *,
    ...
    architecture = build_architecture_audit(source_root=root, package_name="ams", now=now)
...
def _repo_evidence(root: Path) -> dict[str, Any]:
    required_files = [
        ...
        "ams/store.py",
        "ams/replay.py",
        "ams/replay_oracle.py",
        "ams/schema_validation.py",
        "ams/dispatch.py",
        "ams/signed_policy.py",
        "ams/package_manifest.py",
        "ams/capability_policy.py",
        "ams/resource_policy.py",
        "ams/markdown_governance.py",
    ...
    package_files = sorted((root / "ams").glob("*.py")) if (root / "ams").exists() else []
    ...
    return {
        ...
        "live_runner_files_present": _files_present(
            root,
            [
                "ams/discord_canary.py",
                "ams/discord_canary_receipt.py",
                "ams/terminal_source.py",
                "ams/resource_telemetry.py",
                "ams/shadow_approval.py",
            ],
        ),
    }
...
def _authority_kernel_dimension(root: Path, repo: dict[str, Any]) -> dict[str, Any]:
    ...
    if not (root / "ams/shadow_approval.py").exists():
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/store.py", "ams/replay.py", "ams/dispatch.py", "ams/shadow_approval.py"],
    )
...
def _architecture_dimension(architecture: dict[str, Any]) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/architecture_audit.py", "schemas/architecture_audit.schema.json"],
    )
...
def _security_supply_chain_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/signed_policy.py", "ams/package_manifest.py", "ams/provider_auth.py"],
    )
...
def _llm_security_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/capability_policy.py", "ams/rag_retrieval_query.py", "ams/manager_intervention.py"],
    )
...
def _live_ops_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/backup_restore.py", "ams/conformance_pack.py", "ams/discord_canary.py", "ams/terminal_source.py"],
    )
...
def _resource_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/resource_policy.py", "ams/resource_claim.py", "ams/resource_telemetry.py"],
    )
...
def _rag_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/rag_index_plan.py", "ams/rag_embedding_job.py", "ams/rag_retrieval_query.py"],
    )
...
def _multi_agent_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["ams/agent_memory_sim.py", "ams/real_agent_trial.py", "ams/intervention_settlement.py"],
    )
...
def _cyber_physical_dimension(root: Path) -> dict[str, Any]:
    ...
    return _dimension(
        ...
        gaps=gaps,
        evidence_refs=["MILESTONE_31_POULTRY_AI_AMS_ARCHITECTURE.md", "ams/attention_router.py"],
    )
