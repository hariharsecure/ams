...
def run_full_simulation(
    ...
    *,
    ...
    capability_paths = ["ams/simulation.py", "tests/test_m8g_full.py"]
...
def run_incident_simulation(
    ...
    *,
    ...
    capability_paths = ["ams/simulation.py", "tests/test_m8h_incident_fixture.py"]
    architecture_gate = _architecture_gate_for_task(store, task_run, capability_paths)
    blast_radius = _blast_radius_for_task(
        store,
        task_run,
...
def _architecture_gate_for_task(
    ...
    audit = ArchitectureAuditStore(store).create(source_root=repo_root(), package_name="ams")
