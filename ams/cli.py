...
def default_runtime_store() -> Path:
    return Path.home() / ".ams" / "stores" / "ams_store.json"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="AMS local dry-run tools")
    ...
    p_architecture.add_argument("--package-name", default="ams")
    ...
    p_codebase_graph.add_argument("--package-name", default="ams")
    ...
    p_blast_radius.add_argument("--package-name", default="ams")
